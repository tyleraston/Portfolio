...
[Software Demo Video](https://youtu.be/jZsc9xSw0fA)


# Development Environment

The initial stage of this project was developed entirely using Android Studio. While initially considering React Native, further research led me to pivot towards Java with a brief consideration for Native C++. The ultimate decision to go with Java/Android SDK was influenced by the project's time constraints.


# Resources

* [Researching React Native](https://reactnative.dev/docs/native-modules-android)
* [Android SDK Fundamentals](https://developer.android.com/guide/components/fundamentals)
