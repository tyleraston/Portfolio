...
Sprint02 - Setting permissions for external files sources was added into "AndroidManifest.xml". This has to be located using different file views. 
...
* [2-Access documents and other files from shared storage](https://developer.android.com/training/data-storage/shared/documents-files)
